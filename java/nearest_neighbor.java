...
public class nearest_neighbor {
    ...
    public List<JobOffer> nearest_neighbor_job_offers(Professional current_user, List<JobOffer> recent_job_offers) {
        ...
        System.out.println("User");
        System.out.println(Arrays.toString(user_is_contact));
        System.out.println(Arrays.toString(user_has_common_contacts));
        System.out.println(Arrays.toString(user_has_skills));
        ...
        System.out.println(Arrays.toString(distance_list.toArray()));
