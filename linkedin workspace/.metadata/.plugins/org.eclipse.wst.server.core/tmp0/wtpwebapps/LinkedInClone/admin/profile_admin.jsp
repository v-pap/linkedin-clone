        ...
        <div class="w3-row">
            ...
            <div class="w3-container w3-padding w3-card w3-white w3-margin-right w3-margin-left">
                <table style="width: 100%">
                    ...
                    <td>
                        <button type="button" onclick="location.href='/LinkedInClone/AdministratorProfile/edit?id=${user_prof.getId()}'" class="w3-button w3-theme-d2">
            ...
            <div class="w3-col m4">
                ...
                <div class="w3-container w3-card w3-white w3-margin">
                    ...
                    <p><i class="fa fa-user"></i>
                        <a href="/LinkedInClone/AdministratorNetwork?id=${user_prof.getId()}" class="w3-link"> View Network </a>
                    </p>
                </div>
