        ...
        <div class="w3-row">
            ...
            <div class="w3-col">
                <div class="w3-row-padding">
					...
					<c:forEach items="${profs_search}" var="prof_result">
		                <div class="w3-container w3-card w3-white w3-margin">
		                    <table style="width: 100%">
		                        <td>
		                            <p class="w3-center">
		                                <a href="/LinkedInClone/ViewProfileServlet?id=${prof_result.getId()}">
		                                    <img src="/LinkedInClone/ImageServlet?id=${prof_result.getPath()}" class="w3-round-large" style="height:116px;width:116px" alt="Avatar">
		                                </a>
		                            </p>
		                        </td>
		                        <td class="w3-padding">
		                            <h4 class="w3-center"><a href="/LinkedInClone/ViewProfileServlet?id=${prof_result.getId()}" class="w3-link">${prof_result.getName()} ${prof_result.getSurname()}</a></h4>
		                        </td>
		                        <td>
		                            <p>
		                                <i class="fa fa-pencil fa-fw w3-margin-right w3-text-theme"></i> ${prof_result.getJobTitle()}</p>
		                        </td>
		                        <td>
		                            <p>
		                                <i class="fa fa-envelope-open"></i> Email: ${prof_result.getEmail()}</p>
		                            <p>
		                                <i class="fa fa-phone"></i> Phone: ${prof_result.getTelephone()}</p>
		                            </p>
		                        </td>
		                    </table>
		                </div>
