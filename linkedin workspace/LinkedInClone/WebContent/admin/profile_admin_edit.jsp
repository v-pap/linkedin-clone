...
<body class="w3-theme-l5">
    ...
    <div class="w3-container w3-content" style="max-width:66.%;margin-top:80px">
        <!-- The Grid -->
        <div class="w3-row">
		<form action="/LinkedInClone/AdministratorProfile/edit" method="post" enctype='multipart/form-data'>
            <div class="w3-container w3-padding w3-card w3-white w3-margin-right w3-margin-left">
                <table style="width: 100%">
                    <td style="width: 100%">
                        <div class="w3-row" style="width:100%;">
                            <a href="/LinkedInClone/AdministratorProfile?id=${user_prof.getId()}">
                    ...
                    <td>
                        <button type="submit" onclick="check_input();" class="w3-button w3-theme-d2">
                            <i class="fa fa-edit"></i> Update Info</button>
                    </td>
                </table>
            </div>
			<input type="hidden" name="id" value="${user_prof.getId()}">
            <!-- Middle Column -->
            <!-- Middle Column -->
            <div class="w3-col m4">
                ...
                <div class="w3-container w3-card w3-white w3-margin">
                    <br>
                    <img name="profile_img" id="profile_img" src="/LinkedInClone/ImageServlet?id=${user_prof.getPath()}" alt="Avatar" style="width:100%" class="w3-round-large w3-margin-bottom">
                    <table>
                        <td>
                    ...
                    <div class="w3-row w3-padding-8" style="width:100%;">
                        <input id="name" name="name" type="text" placeholder="Name" value="${user_prof.getName()}" class="w3-border w3-padding" style="width:100%;" />
                    </div>
                    <div class="w3-row w3-padding-8" style="width:100%;">
                        <input id="surname" name="surname" type="text" placeholder="Surname" value="${user_prof.getSurname()}" class="w3-border w3-padding" style="width:100%;" />
                    </div>
                    <hr class="w3-clear">
                    <div class="w3-row w3-padding-8" style="width:100%;">
                        <input id="description" name="description" type="text" placeholder="Description" value="${user_prof.getJobTitle()}" class="w3-border w3-padding" style="width:100%;" />
                    </div>
                    <hr class="w3-clear">
                    <h4>Contact Info</h4>
                    <div class="w3-row w3-padding-8" style="width:100%;">
                        <input name="telephone" type="text" placeholder="Phone" value="${user_prof.getTelephone()}" class="w3-border w3-padding" style="width:100%;" />
                    </div>
                </div>
                        ...
                        <td>
                            <div style="float:right;">
                                <input type="radio" name="w_visibility" value="Public" style="vertical-align: sub"
                                    ${user_prof.getExperiencePrivate()=='false'?'checked':''}> Public
                                <input type="radio" name="w_visibility" value="Private" style="vertical-align: sub"
                                ${user_prof.getExperiencePrivate()=='true'?'checked':''}>
                                Private
                            </div>
                        </td>
                    </table>
                    <div name="work_wrapper" id="work_wrapper">
                    <c:forEach items="${user_prof.getExperiences()}" var="experience" varStatus="loop">
                        ...
                        <td>
                            <fdiv style="float:right;">
                                <input type="radio" name="e_visibility" value="Public" style="vertical-align: sub"
                                    ${user_prof.getEducationPrivate()=='false'?'checked':''}> Public
                                <input type="radio" name="e_visibility" value="Private" style="vertical-align: sub"
                                ${user_prof.getEducationPrivate()=='true'?'checked':''}>
                                Private
                            </div>
                        </td>
                    </table>
                    <div name="education_wrapper" id="education_wrapper">
                    <c:forEach items="${user_prof.getEducations()}" var="education" varStatus="loop">
                        ...
                        <td>
                            <div style="float:right;">
                                <input type="radio" name="s_visibility" value="Public" style="vertical-align: sub"
                                    ${user_prof.getSkillsPrivate()=='false'?'checked':''}> Public
                                <input type="radio" name="s_visibility" value="Private" style="vertical-align: sub"
                                ${user_prof.getSkillsPrivate()=='true'?'checked':''}>
                                Private
                            </div>
                        </td>
                    </table>
